...
> = {
  "organization-risk-advisory": {
    ...
    highlights: [
      ...
      },
      {
        ...
        desc: "Build a structured risk framework aligned with your strategy.",
        icon: Network,
      },
      {
        title: "Actionable Insights",
        desc: "Deliver clear, data-driven insights for confident decision-making.",
        icon: FileText,
      },
      {
        title: "Regulatory Alignment",
        desc: "Stay ahead of evolving regulations and governance expectations.",
        icon: Compass,
      },
    ],
    benefits: [
      ...
      },
      {
        ...
        desc: "Identify and prioritize risks before they escalate.",
        icon: TrendingUp,
      },
      {
        title: "Regulatory Confidence",
        desc: "Align with global standards and compliance needs.",
        icon: ShieldCheck,
      },
      {
        title: "Protect Business Value",
        desc: "Safeguard reputation, operations, and growth.",
        icon: DollarSign,
      },
    ],
    approach: [
      {
        step: "01",
        title: "Understand",
        desc: "We learn your business, strategy, and risk landscape.",
      },
      {
        step: "02",
        title: "Assess",
        desc: "Identify and evaluate key risks and control gaps.",
      },
      {
        step: "03",
        title: "Advise",
        desc: "Design a tailored risk framework and governance model.",
      },
      {
        step: "04",
        title: "Enable",
      ...
      },
      {
        step: "05",
        title: "Evolve",
        desc: "Continuously monitor, review, and adapt to emerging risks.",
      },
    ],
    deliverables: [
  ...
  "grc-rapid-assessment": {
    ...
    description:
      "A comprehensive 30-day review designed to establish a solid baseline of your current governance, risk, and compliance posture.",
    icon: Gauge,
    overviewText:
      "Organizations need to quickly identify vulnerabilities and map out a path to compliance. Our GRC Rapid Assessment delivers a swift, deep-dive analysis of your controls and regulatory alignment to build an actionable, prioritized GRC improvement strategy.",
    highlights: [
      {
        title: "30-Day Velocity",
        desc: "Fast-tracked analysis to identify immediate gaps without operational lag.",
        icon: Gauge,
      },
      {
        title: "Baseline Posture",
        desc: "Establish a clear risk benchmark based on industry-standard frameworks.",
        icon: Network,
      },
      {
        title: "Prioritized Action",
        desc: "Receive a step-by-step roadmap of what to remediate first.",
        icon: FileText,
      },
      {
        title: "Regulatory Readiness",
        desc: "Determine audit preparedness for NIST, ISO, HIPAA, or SOC 2.",
        icon: Compass,
      },
    ],
    benefits: [
      {
        ...
        desc: "Gain absolute clarity on your security and compliance gaps.",
        icon: ShieldCheck,
      },
      {
        title: "Audit Prep",
        desc: "Proactively discover weaknesses before external audits begin.",
        icon: TrendingUp,
      },
      {
    ...
    approach: [
      {
        step: "01",
        title: "Discover",
        desc: "Gather existing policy documentation, controls, and GRC data.",
      },
      {
        step: "02",
        title: "Analyze",
        desc: "Evaluate controls against NIST, ISO, or SOC 2 frameworks.",
      },
      {
        step: "03",
        title: "Identify Gaps",
        desc: "Pinpoint where compliance and security controls fall short.",
      },
      {
        step: "04",
        title: "Build Roadmap",
        desc: "Draft a prioritized remediation plan with timelines and owners.",
      },
      {
        step: "05",
        title: "Present",
        desc: "Deliver a clear executive brief and detailed technical reports.",
      },
    ],
    deliverables: [
  ...
  "ai-governance": {
    ...
    description:
      "Implement robust governance frameworks for machine learning, generative AI, and automated decision systems.",
    icon: Activity,
    overviewText:
      "AI introduces unprecedented regulatory, privacy, and security challenges. We help organizations establish practical policies, risk thresholds, and control parameters to safely design, deploy, and scale AI technologies.",
    highlights: [
      {
        title: "ISO 42001 Alignment",
        desc: "Prepare for international AI management system certifications.",
        icon: Activity,
      },
      {
        title: "Bias Mitigation",
        desc: "Establish validation pipelines to identify and mitigate AI bias.",
        icon: Network,
      },
      {
        title: "Risk Classification",
        desc: "Categorize AI use cases based on EU AI Act threat levels.",
        icon: FileText,
      },
      {
    ...
    benefits: [
      {
        ...
        desc: "Deploy generative AI projects with confidence and clear boundaries.",
        icon: ShieldCheck,
      },
      {
    ...
    approach: [
      {
        ...
        desc: "Discover and catalog all active AI and ML systems in use.",
      },
      {
        step: "02",
        title: "Risk Category",
        desc: "Evaluate AI systems for privacy, security, and ethical impacts.",
      },
      {
        step: "03",
        title: "Policy Design",
        desc: "Establish generative AI acceptable use guidelines.",
      },
      {
        step: "04",
        title: "Control Setup",
        desc: "Configure monitoring metrics for bias, accuracy, and drift.",
      },
      {
        step: "05",
        title: "Advisory Review",
        desc: "Audit models periodically to verify alignment with ISO 42001.",
      },
    ],
    deliverables: [
  ...
  "ma-risk-due-diligence": {
    ...
    icon: Handshake,
    overviewText:
      "Hidden cyber liabilities can compromise transaction values and delay integrations. Our due diligence services analyze target GRC postures to identify material exposures, estimating integration costs before signing deals.",
    highlights: [
      {
      ...
      },
      {
        ...
        desc: "Examine target alignment with HIPAA, GDPR, SOC 2, or PCI-DSS.",
        icon: Network,
      },
      {
        title: "Integration Cost",
        desc: "Outline post-close technology consolidation costs.",
        icon: FileText,
      },
      {
    ...
    benefits: [
      {
        title: "Protect Deal Value",
        desc: "Negotiate purchase prices based on validated risk findings.",
        icon: ShieldCheck,
      },
      {
        title: "Speed Integration",
    ...
    approach: [
      ...
      {
        step: "02",
        title: "Assess Targets",
        desc: "Request GRC artifacts and perform outside-in scans.",
      },
      {
        step: "03",
        title: "Identify Gaps",
        desc: "Map target deficiencies against required security standards.",
      },
      {
        step: "04",
        title: "Financial Impact",
        desc: "Estimate remediation budgets and timeline impacts.",
      },
      {
        step: "05",
        title: "Final Reporting",
        desc: "Deliver due diligence reports for deal committees.",
      },
    ],
    deliverables: [
                  ...
                  {QUICK_SERVICES_LINKS.map((link, idx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <ArrowUpRight
                          className={`w-4.5 h-4.5 ${isCurrent ? "text-white" : "text-gray-400 group-hover:text-primary"}`}
                        />
                      </Link>
                    );
                  })}
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-[14px] text-gray-500 font-medium leading-relaxed">
                    Our approach delivers measurable impact by strengthening
                    governance, reducing uncertainty, and enabling proactive
                    risk management.
                  </p>
                </div>
              ...
              <div className="space-y-8">
                ...
                <div className="flex flex-col md:flex-row md:items-start items-center justify-between gap-6 md:gap-2 w-full">
                  {data.approach.map((step, idx) => (
                    <div
                      key={idx}
                      className="group flex-1 flex flex-col items-center text-center px-1 relative w-full"
                    >
                      {/* Circle badge */}
