          ...
          <div className="relative flex flex-col justify-center items-center rounded-[24px] overflow-hidden shadow-lg bg-gradient-to-b from-[#0A0580] via-[#050266] to-[#04014F] p-8 sm:p-10 text-white min-h-[420px] lg:min-h-0">
            ...
            <div className="relative z-10 text-center max-w-sm">
              ...
              <p className="text-white/85 text-[14px] sm:text-[15px] leading-relaxed">
                TAC Solutions is a trusted partner in cybersecurity and
                compliance. We help organizations navigate risk, strengthen
                resilience, and achieve their business goals through practical,
                results-driven solutions and expert guidance. Our mission is
                simple: empower organizations to build a secure, compliant, and
