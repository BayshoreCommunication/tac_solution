    ...
    <section className="relative bg-gray-50/50 border-t border-gray-100 py-8 md:py-12 overflow-hidden">
      <Container className="relative z-10">
        ...
        <div className="bg-white border border-gray-100 rounded-[32px] p-8 sm:p-12 md:p-16 shadow-[0_8px_30px_rgb(0,0,0,0.015)] w-full">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-10 md:gap-y-0 divide-y divide-gray-100 md:divide-y-0 md:divide-x md:divide-gray-100">
            {/* Pillar 1: Compliant */}
            <div className="flex flex-col items-center text-left pb-10 md:pb-0 md:pr-8 md:pl-0 px-10">
              ...
              <p className="text-gray-500 text-[15px] text-center sm:text-base leading-relaxed">
            ...
            <div className="flex flex-col items-center text-left pt-10 md:pt-0 md:pl-8 md:pr-0 px-10">
              <div className="w-16 h-16 rounded-full border-[3px] border-primary bg-primary/5 flex items-center justify-center mb-6 shadow-sm">
