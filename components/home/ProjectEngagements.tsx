...
const ENGAGEMENTS = [
  {
    ...
    badge: "ENTRY POINT",
    icon: <Gauge className="h-6 w-6 transition-colors duration-300" strokeWidth={1.5} />,
  ...
  {
    title: "NIS2 / DORA EU advisory",
    badge: "EU REGULATORY",
    icon: <Globe className="h-6 w-6 transition-colors duration-300" strokeWidth={1.5} />,
    description: "EU regulatory readiness assessment, gap analysis, and remediation roadmap. TAC Solutions EU presence from 2027.",
  },
  {
    title: "ServiceNow IRM consulting",
    badge: "TECHNOLOGY",
    icon: <Cloud className="h-6 w-6 transition-colors duration-300" strokeWidth={1.5} />,
    description: "Implementation oversight and advisory for ServiceNow IRM Phase 1 through go-live. Based on live integration experience.",
  },
  {
    title: "Healthcare AI governance",
    badge: "HEALTHCARE AI",
    icon: <Activity className="h-6 w-6 transition-colors duration-300" strokeWidth={1.5} />,
  ...
  },
  {
    ...
    badge: "M&A",
    icon: <Handshake className="h-6 w-6 transition-colors duration-300" strokeWidth={1.5} />,
            ...
            >
              ...
              <div>
                <div className="flex items-center justify-between mb-6">
                  {/* Icon Wrapper */}
                  <div className="w-14 h-14 rounded-full flex items-center justify-center border bg-gray-50 border-gray-100 text-gray-700 group-hover:bg-primary/5 group-hover:border-primary/10 group-hover:text-primary transition-colors duration-300">
                ...
                {/* Badge Category */}
                <span className="inline-block px-3 py-1 text-[10px] font-bold tracking-wider rounded-md bg-gray-50 text-gray-500 group-hover:bg-primary/10 group-hover:text-primary transition-colors duration-300 mb-6">
                  {item.badge}
                </span>
