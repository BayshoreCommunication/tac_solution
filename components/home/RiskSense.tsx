...
const STEPS = [
  {
    number: "1",
    title: "What it is",
    icon: <ClipboardCheck className="h-7 w-7 text-primary transition-transform duration-300 group-hover:scale-110" strokeWidth={1.5} />,
    description: "An AI-enabled decision support tool that helps risk and compliance professionals determine when situations should be classified as monitor-only, risk, elevated risk, or issue.",
  },
  {
    number: "2",
    title: "Mission",
    icon: <BookOpen className="h-7 w-7 text-primary transition-transform duration-300 group-hover:scale-110" strokeWidth={1.5} />,
    description: "Improve consistency, clarity, and defensibility in risk escalation decisions without replacing professional judgment or governance.",
  },
  {
    number: "3",
    title: "Who it’s for",
    icon: <Code2 className="h-7 w-7 text-primary transition-transform duration-300 group-hover:scale-110" strokeWidth={1.5} />,
    description: "Risk Management, Compliance, Technology Risk, Operational Risk, and Audit teams in financial services and healthcare — with a framework designed to scale to other regulated sectors.",
  },
  {
    number: "4",
    title: "How it works",
    icon: <Briefcase className="h-7 w-7 text-primary transition-transform duration-300 group-hover:scale-110" strokeWidth={1.5} />,
    description: "Evaluates scenarios using risk dimensions (control effectiveness, impact, likelihood, duration, regulatory sensitivity). Hard rules act as deterministic escalation gates. Advisory scoring supports consistency — not certainty. Final accountability remains with management.",
  },
];
      ...
      <Container className="relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20 md:mb-24">
          ...
          <p className="text-[15px] sm:text-base text-gray-500 font-medium max-w-2xl mx-auto leading-relaxed">
            Advisory judgment support for financial services &amp; healthcare — scalable to broader regulated sectors
          </p>
        </div>
